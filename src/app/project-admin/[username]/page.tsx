      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 20 }}>
        ...
        <div>
          ...
          <p style={{ margin: "8px 0 0", fontSize: 11, color: ds.inkFaint, lineHeight: 1.4 }}>
            * Note: One-time Base Application Form points (e.g. 100 base, 25 beginner issues, 20 README quality) are not included as they cannot be parsed from GitHub API.
          </p>
        </div>
      </div>
    </div>
